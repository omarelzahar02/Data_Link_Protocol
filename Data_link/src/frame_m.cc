...
std::string FrameDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const {
    ...
    switch (field) {
        case FIELD_Seq_Num:
            return long2string(pp->getSeq_Num());
        case FIELD_M_Type:
            return long2string(pp->getM_Type());
        case FIELD_ack:
            return long2string(pp->getAck());
        case FIELD_M_Payload:
            return oppstring2string(pp->getM_Payload());
        case FIELD_mycheckbits:
            return "";
        default:
            return "";
    }
...
void FrameDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const {
    ...
    switch (field) {
        case FIELD_Seq_Num:
            pp->setSeq_Num(string2long(value));
            break;
        case FIELD_M_Type:
            pp->setM_Type(string2long(value));
            break;
        case FIELD_ack:
            pp->setAck(string2long(value));
            break;
        case FIELD_M_Payload:
            pp->setM_Payload((value));
            break;
        default:
...
omnetpp::cValue FrameDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const {
    ...
    switch (field) {
        case FIELD_Seq_Num:
            return pp->getSeq_Num();
        case FIELD_M_Type:
            return pp->getM_Type();
        case FIELD_ack:
            return pp->getAck();
        case FIELD_M_Payload:
            return pp->getM_Payload();
        case FIELD_mycheckbits:
            return omnetpp::toAnyPtr(&pp->getMycheckbits());
            break;
        default:
...
void FrameDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue &value) const {
    ...
    switch (field) {
        case FIELD_Seq_Num:
            pp->setSeq_Num(omnetpp::checked_int_cast<int>(value.intValue()));
            break;
        case FIELD_M_Type:
            pp->setM_Type(omnetpp::checked_int_cast<int>(value.intValue()));
            break;
        case FIELD_ack:
            pp->setAck(omnetpp::checked_int_cast<int>(value.intValue()));
            break;
        case FIELD_M_Payload:
            pp->setM_Payload(value.stringValue());
            break;
        default:
            throw omnetpp::cRuntimeError("Cannot set field %d of class 'Frame_Base'", field);
    }
